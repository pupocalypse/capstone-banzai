...
const CharacterSheet = () => {
  return (
    <main className="character-sheet">
      ...
      <section className="character-sheet__status-container"></section>
      ...
      <section className="character-sheet__rings-container">
        ...
        <div className="character-sheet__void-container">
          ...
          <div className="character-sheet__void-slots">
            <div className="character-sheet__void-slots-image void-spent"></div>
            <div className="character-sheet__void-slots-image "></div>
