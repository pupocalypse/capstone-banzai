  ...
  return (
    <main className="home">
      ...
      <h3 className="home__sub-heading">
        A{" "}
        <span className="home__sub-heading--pop">Legend of the Five Rings</span>{" "}
      ...
      <p className="home__body-text">
        ...
        the two dice to keep (usually the highest) to attempt to beat&mdash;or
        deliberately fail&mdash;the Target Number set by the GM.
      </p>
      <Button
        as={Link}
